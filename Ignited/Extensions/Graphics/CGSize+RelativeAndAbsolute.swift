...
{
    func getAbsolute(for traits: DeltaCore.ControllerSkin.Traits, inputMappingMode: Bool = false) -> CGSize
    {
    ...
    func getRelative(for traits: DeltaCore.ControllerSkin.Traits, inputMappingMode: Bool = false) -> CGSize
    {
        guard !inputMappingMode else {
